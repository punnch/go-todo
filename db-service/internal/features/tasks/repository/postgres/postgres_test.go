...
func TestRepo_CreateDuplicate(t *testing.T) {
	...
	task := domain.Task{Title: "programming", Description: "5 hours"}
...
func TestRepo_GetAll(t *testing.T) {
	...
	repo.Create(ctx, domain.Task{Title: "task1", Description: "task1"})
	repo.Create(ctx, domain.Task{Title: "task2", Description: "task2"})
...
func TestRepo_GetAll_FilterByID(t *testing.T) {
	...
	task1, _ := repo.Create(ctx, domain.Task{Title: "task1", Description: "task1"})
	repo.Create(ctx, domain.Task{Title: "task2", Description: "task2"})
...
func TestRepo_Get(t *testing.T) {
	...
	created, _ := repo.Create(ctx, domain.Task{Title: "task", Description: "title"})
